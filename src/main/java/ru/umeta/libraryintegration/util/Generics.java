...
/**
 * Created by k.kosolapov on 06/05/2015. The source code is from https://github.com/dropwizard/dropwizard
 */
...
public class Generics {
     ...
     * @return the class's type parameter
     */
    @SuppressWarnings("unchecked") public static <T> Class<T> getTypeParameter(Class<?> klass, Class<? super T> bound) {
    ...
    @SuppressWarnings("unchecked") private static <T> Class<T> determineClass(Class<? super T> bound, Type candidate) {
